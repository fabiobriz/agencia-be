...
public class JWTFilterValidate extends BasicAuthenticationFilter {
  ...
  public static final String HEADER_ATR = "Authorization";
  ...
  protected void doFilterInternal(HttpServletRequest request,
    ...
    String atr = request.getHeader(HEADER_ATR);
    ...
    if (!atr.startsWith(PREFIX_ATR)) {
      chain.doFilter(request, response);
      return;
    }

    String token = atr.replace(PREFIX_ATR, "");
